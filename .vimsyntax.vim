...
syn keyword cPrintf	printf ft_putchar ft_putstr ft_putendl ft_putnbr ft_put_nultab ft_putchar_fd ft_putstr_fd ft_putendl_fd syntax_error_near dprintf print_line ft_endl_tty
