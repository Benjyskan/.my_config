syn keyword	cMemoryFunc	ft_lstnew malloc ft_memalloc ft_memmove ft_strdup ft_strndup ft_strnew ft_strsplit ft_strsub ft_swap ft_strjoin ft_itoa strsplit_multi getcwd
...
syn keyword cType	t_dlst t_lst t_tetri_coo t_opt t_ldir t_myenv
